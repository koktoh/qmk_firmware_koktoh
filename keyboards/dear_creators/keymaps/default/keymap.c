...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        // KC_ESC,  KC_EQL,  XXXXXXX, KC_MUTE, XXXXXXX,                                            XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_BSPC,
        ...
        KC_X,    KC_Y,    KC_Z,    KC_0,    KC_1,    KC_2,    TO(1),            TO(2),   KC_Y,    KC_Z,    KC_0,    KC_1,    KC_2,    KC_3,
                 KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,             KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
        _______, _______, _______, _______,                                                              _______, _______, _______, _______,
        KC_ESC,  KC_EQL,  XXXXXXX, KC_MUTE, XXXXXXX,                                            XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_BSPC,
        KC_GRV,  BL_TOGG, RGB_TOG, KC_3,    KC_4,    KC_5,                             KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        KC_TAB,  BL_INC,  RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI,                          KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
        KC_LCTL, BL_DEC,  KC_S,    RGB_HUD, RGB_SAD, RGB_VAD,                          KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
