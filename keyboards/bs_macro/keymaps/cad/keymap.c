...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base
        ,-----------------------------------------------------------.
        | Knob: Vol Down/Up | Change CAD layer | Knob: Page Down/Up |
        |-------------------+------------------+--------------------|
        | Mute              | Up               | Play/Pose          |
        |-------------------+------------------+--------------------|
        | Left              | Down             | Right              |
    ...
    */
    [_BASE] = LAYOUT( \
        XXXXXXX, TO(_CAD), XXXXXXX, \
        KC_MUTE, KC_UP,      KC_MPLY, \
        KC_LEFT, KC_DOWN,    KC_RGHT \
    ),
    /* Cad
        ,-------------------------------------------------------------.
        | Knob: Zoom Out/In | Change MEDIA layer | Knob: Page Down/Up |
        |-------------------+--------------------+--------------------|
        | Undo              | Media Stop         | Redo               |
        |-------------------+--------------------+--------------------|
        | Media Previous    | XXXXXXX            | Media Next         |
        `-------------------------------------------------------------'
    */
    [_CAD] = LAYOUT( \
        XXXXXXX,    TO(_MEDIA), XXXXXXX, \
        LCTL(KC_Z), KC_UP,      LCTL(KC_Y), \
        KC_LEFT,    KC_DOWN,    KC_RGHT \
    ),
    /* Media
        ,----------------------------------------------------------.
        | Knob: Vol Down/Up | Change FN layer | Knob: Page Down/Up |
        |-------------------+-----------------+--------------------|
    ...
    */
    ...
    /* Fn
        ,--------------------------------------------------------------.
        | Knob: Vol Down/Up | Change CONFIG layer | Knob: Page Down/Up |
        |-------------------+---------------------+--------------------|
    ...
    */
    ...
    /* Config
        ,---------------------------------------------------------------------.
        | Knob: Vol Down/Up | Change BASE layer          | Knob: Page Down/Up |
        |-------------------+----------------------------+--------------------|
...
void encoder_update_user(uint8_t index, bool clockwise) {
    bool is_cad_layer = layer_state_is(_CAD);
